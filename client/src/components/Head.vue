  ...
  <div>
    <el-row>
      <el-col :span="24">
        ...
        <span  class="nav1">&nbsp;</span>
        <router-link  class="nav1 el-icon-user" to="/regist">注册</router-link>
        <span class="nav1">&nbsp;</span>
        <router-link  class="nav1 el-icon-s-custom" to="/login">登录</router-link>
      ...
      <el-col :span="24">
        <div class="demo-image">
          <div class="block">
            ...
            <el-image
              style="width: 100%; height: 100%" src='../../static/img/Bg-01.png'></el-image>
          </div>
        </div>
...
<!-- background-color="#545c64" -->
          <el-menu class="el-menu-demo" style="width:100%;" :default-active="this.$route.path"  router mode="horizontal" @select="handleSelect"
